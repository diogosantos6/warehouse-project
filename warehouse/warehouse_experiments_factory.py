    ...
    def build_experiment(self) -> Experiment:
        ...
        for pair in agent_search.pairs:
            ...
            if state.matrix[pair.cell1.line][pair.cell1.column] == constants.FORKLIFT:
                ...
                state.line_forklift = pair.cell1.line
                state.column_forklift = pair.cell1.column - 1 if state.matrix[pair.cell1.line][
                                                                     pair.cell1.column - 1] == constants.EMPTY else pair.cell1.column + 1

            goal = copy.copy(pair.cell2)

            if state.matrix[pair.cell2.line][pair.cell2.column] != constants.EXIT:
                goal.column = pair.cell2.column - 1 if state.matrix[pair.cell2.line][
                                                           pair.cell2.column - 1] == constants.EMPTY else pair.cell2.column + 1
